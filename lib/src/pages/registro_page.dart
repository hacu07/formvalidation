...
class RegistroPage extends StatelessWidget {
  ...
  Widget _crearEmail(LoginBloc bloc){
    ...
    return StreamBuilder(
      //Escucha cambios enviados por el STREAM
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot){
          return Container(
            ...
            child: TextField(
              ...
              // ENVIA LOS CAMBIOS POR EL STREAM
  ...
  Widget _crearFondo(BuildContext context){
    ...
    return Stack(
      children: [
        ...
        Positioned(bottom: 10.0,right: -30.0,child: circulo),
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text('Harold Cupitra', style: TextStyle(color: Colors.white, fontSize: 25.0))
            ],
          ),
        )
      ],
